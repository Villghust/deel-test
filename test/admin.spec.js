...
describe('Admin', () => {
    describe('GET /admin/best-profession', () => {
        ...
        it('should return not found error if there are no jobs within given time range', async () => {
            const { statusCode, body } = await request(app)
                .get('/admin/best-profession')
            ...
            expect(body).toEqual({
                error: 'No paid job in this date range',
            });
        });
    });
    ...
    describe('GET /admin/best-clients', () => {
        ...
        it('should return an empty array if there are no jobs within given time range', async () => {
            const { statusCode, body } = await request(app)
                .get('/admin/best-clients')
                .query({ start: '2021-08-10T09:00:00.000Z' })
                .query({ end: '2021-08-16T23:59:59.000Z' });
